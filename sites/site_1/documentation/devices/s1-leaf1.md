...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$xMDXfjg.2HCIQc0a$clL53nPBOVSrhabcUqTXJfErmZs7mu4ROs5MkqIjm/O7FlJhIiw2lylqqZ2Bru44CvyhMsqQfUra1jhi.GeTL/
```

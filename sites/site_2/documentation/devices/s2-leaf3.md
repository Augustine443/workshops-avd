...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$RCiUvPQxypAr5Xbc$vTdD7s3CwKComQYVaxG8XQHUwCCPDjsbE3iC1a.V61TQdy3DCs0OMZyX32WIaWcktvz5Vtp0T7B/3MIDdFm2w/
```
